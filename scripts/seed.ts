...
const SEED_USER_ID = "user_32QfeGztyA5ayR3QGHR6Mi4nU6q";
...
const generateTransactionsForDay = (day: Date) => {
    ...
    for (let i = 0; i < numTransactions; i++) {
        ...
        SEED_TRANSACTIONS.push({
            ...
            accountId: SEED_ACCOUNTS[0].id, //Assuming alwats using the first account for simplicity
            categoryId: category.id,
            date: day,
            amount: formattedAmount,
            payee: "Merchant",
            notes: "Randome transaction",
        });
    }
};
